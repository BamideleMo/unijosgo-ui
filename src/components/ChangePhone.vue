        ...
        <form class="w-11/12 lg:w-6/12 mx-auto mt-10 sm:mt-20 bg-white p-3 sm:p-10 rounded-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 sm:gap-10 text-black">
                <div class="space-y-4 text-xs">
                    <p class="mt-6 sm:mt-5.5">You will be asked to Login with this new Phone number & enter the confirmation code you'll receive.
                    </p>
                </div>
                <div class="">
                    <div class="mt-6 space-y-4 text-sm">
                        <div class="">
                            <label for="" class="font-bold">Another Phone Number: <span class="text-red-600">*</span></label>
                            <input type="text" placeholder="e.g.: 08187084716" v-model="formData.username" @blur="v$.username.$touch" @keydown.space.prevent class="placeholder:text-blue-200 w-full shadow-lg mt-1 rounded-md outline-none px-1 py-2 h-10 text-xs border-2 bg-transparent border-blue-900" />
