...
<template>
    <span v-if="isProcessing" class="border-2 border-red-600 rounded hover:opacity-60 drop-shadow-lg bg-white py-2 px-4 text-xs animate-pulse text-white">Signing in ...</span>
