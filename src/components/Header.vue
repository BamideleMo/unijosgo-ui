...
<template>
    <div v-if="showMenu" class="w-screen h-screen top-0 fixed bg-black bg-opacity-90 z-50 flex ">
        ...
        <div class="bg-white w-60 xl:w-80 text-xs xl:text-base">
            <div class="flex border-b shadow-lg py-4 pl-4 pr-4">
                <div class="grow"><img src="/icon.png" class="h-8"/></div>
                <div class="w-8">
                    <IconClose @click="toggleShowMenu" class="cursor-pointer hover:opacity-60" />
                </div>
            </div>
            <ol class="">
                ...
                <li v-if="authStore.cid" class="border-b p-4">
    ...
    <div class="bg-white border-b shadow-lg py-2">
        <div class="w-11/12 sm:w-10/12 lg:w-9/12 mx-auto flex justify-between">
            ...
            <div class="pt-3 sm:pt-3 drop-shadow-lg space-x-4">
                <MenuIcon @click="toggleShowMenu" class="cursor-pointer hover:opacity-60 -mt-1"  />
            </div>
        </div>
    </div>
</template>