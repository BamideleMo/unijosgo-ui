...
<template>
  <div>
    <h2 class="text-green-400 border-b border-gray-900 font-semibold text-center text-xl">
      Subscribe
    </h2>
    ...
    <p class="mt-3 text-xs text-white">
      By clicking the submit button you agree to recieve an SMS to verify your
      phone number.
    </p>
  </div>
</template>
