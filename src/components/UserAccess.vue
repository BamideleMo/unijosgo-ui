        ...
        <div class="mt-6 text-xs w-full lg:w-10/12 border border-gray-500 p-2 sm:p-3 drop-shadow-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 gap-3">
                <div class="sm:col-span-3 flex space-x-1.5 lg:space-x-3">
                    <select v-model="formData.campus" @blur="v$.campus.$touch" class="bg-white border border-black h-12 p-2 w-full outline-none disabled:text-red-600" required>
                    ...
                    <input v-model="formData.username" @blur="v$.username.$touch" class="bg-white border border-black h-12 p-2 w-full outline-none placeholder:text-gray-300" placeholder="Type Your Email" />
                </div>
